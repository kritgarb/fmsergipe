    ...
    return (
      <div className="relative">
        <input
          ...
          type={type}
          className={cn(
            'block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-sm border-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-primary focus:outline-none focus:ring-0 focus:border-primary peer',
            className
          )}
          ref={ref}
          placeholder=" "
