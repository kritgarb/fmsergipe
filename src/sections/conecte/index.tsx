    ...
    <div className={styles.container}>
      ...
      <div className={styles.case2}>
        ...
        <p className={styles.textArea}>
          ...
          <a
            href="http://www.fmsergipe.com.br/radio-ao-vivo"
            target="_blank"
            rel="noopener noreferrer"
            className="mt-5 flex items-center justify-center gap-2 text-white rounded-md text-xl bg-[#FF060B] hover:bg-[#D00406] hover:shadow-lg transition-all duration-300 ease-in-out px-6 py-2"
          >
